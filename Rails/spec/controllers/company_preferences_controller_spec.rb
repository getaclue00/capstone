...
RSpec.describe CompanyPreferencesController, type: :controller do
  ...
  # CompanyPreference. As you add validations to CompanyPreference, be sure to
  ...
  # CompanyPreferencesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "DELETE #destroy" do
    it "destroys the requested company_preference" do
      company_preference = CompanyPreference.create! valid_attributes
      expect {
        delete :destroy, params: {id: company_preference.to_param}, session: valid_session
      }.to change(CompanyPreference, :count).by(-1)
    end

    it "redirects to the company_preferences list" do
      company_preference = CompanyPreference.create! valid_attributes
      delete :destroy, params: {id: company_preference.to_param}, session: valid_session
      expect(response).to redirect_to(company_preferences_url)
    end
  end
