class AppointmentsController < ApplicationController
  ...
  def create
    begin
      ...
      if @appointment.save!
        AppointmentsMailer.new_appointment_created(@appointment).deliver_later unless @appointment.completed?
  ...
  def update
    begin
      ...
      if appointment.update!(sanitized_params)
        ...
        if change_set = appointment.versions.last.changeset[:status]
          new_status = change_set[1]
