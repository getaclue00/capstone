class Car < ApplicationRecord
	...
	validates :size, inclusion: { in: %w(small van truck large\ SUV),
    message: "Please enter a valid size: small, van, truck, or large SUV" }

	belongs_to :client, optional: true #belongs_to used for model with FK
